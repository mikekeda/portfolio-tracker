...
class DailyPrice(Base):
    ...
    day = Column(Integer, nullable=False)  # days since 1970-01-01
    ...
    # Constraints
    __table_args__ = (
        UniqueConstraint('symbol', 'day', name='uq_symbol_day'),
...
class CurrencyRate(Base):
    ...
    # Constraints
    __table_args__ = (
        UniqueConstraint('from_currency', 'to_currency', 'rate_date', name='uq_currency_rate_date'),
    )
...
class PortfolioSnapshot(Base):
    ...
    def __repr__(self):
        return f"<PortfolioSnapshot(date='{self.snapshot_date}', value={self.total_value_gbp})>"
